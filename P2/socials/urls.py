...
urlpatterns = [
    ...
    path('add_blog/', AddBlog.as_view(), name='add_blog'),
    path('like/<str:restaurant_name>/', LikeRestaurantView.as_view(), name='like_restaurant'),
    path('unlike/<str:restaurant_name>/', UnLikeRestaurantView.as_view(), name='unlike_restaurant'),
    path('like/<int:blog_id>/', LikeBlogView.as_view(), name='like_blog'),
    path('unlike/<int:blog_id>/', UnLikeBlogView.as_view(), name='unlike_blog'),
