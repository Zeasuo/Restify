...
const EditRestaurant = () => {
    ...
    useEffect(() => {
        fetch("http://127.0.0.1:8000/restaurants/get/"+ localStorage.getItem("restaurant")+"/", {
                method: "GET",
                headers: {
                    ...
                    >
                        <Grid>
                            <TextField
                                ...
                                value={nameState}
                                onChange={(e) => validate_name(e.target.value)}
                                autoComplete="email"
                                helperText={
                                    !nameNotification
                            ...
                            <TextField
                                ...
                                value={addressState}
                                onChange={(e) => validate_address(e.target.value)}
