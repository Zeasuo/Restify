    ...
    return <>
        <div className="align-items-end align-items-sm-end px-4 pt-5 text-white min-vh-100 position-fixed"> 
            ...
            <Navbar bg="light" id = 'Edit Restaurant'>
                <Container className='fs-4'>
                    <Navbar.Brand onClick={()=>navigate("../../../")}> <PencilSquare className="text-primary"></PencilSquare> <span className ="ms-1 d-none d-sm-inline text-primary">Edit Restaurant </span></Navbar.Brand>
                </Container>
            </Navbar>
        </div>
    </>
