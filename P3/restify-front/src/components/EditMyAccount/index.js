...
const EditMyAccount = () =>{
    ...
    const [phone_number_notification, setPhoneNumberNotification] = useState("")
            ...
            <div className = "bg-white p-3" style={{margin:"3% 20% 10% 5%"}}>
                <Container>
                    <Form.Group className="input-group mb-4" >
                        ...
                        >
                        <Form.Label htmlFor='avatar' onMouseEnter={(e)=>e.target.style = {opacity: '0.5'}}> <Image src={avatar} roundedCircle width="297" height="300" htmlFor='avatar' id='avatarImg'/> </Form.Label>
                        </OverlayTrigger>
                    </Form.Group>
                </Container>
                ...
                <Row>
                    <Col>
                        <Form.Group className="input-group mb-4" controlId= "firstname">
                            <Form.Control type="text" placeholder="First Name" defaultValue={user.first_name} onChange={(e)=>validateName(e.target.value)}/>
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group className="input-group mb-4" controlId= "lastname">
                            <Form.Control type="text" placeholder="Last Name" defaultValue={user.last_name} onChange={(e)=>validateName(e.target.value)}/>
                        </Form.Group>
                ...
                <Form.Group className="input-group mb-4" controlId="email">
                    <Form.Control type="text" placeholder="Email" defaultValue={user.email} onChange={(e)=>validateEmail(e.target.value)}/>
                </Form.Group>
                ...
                <Form.Group className="input-group mb-4" controlId="birthday">
                    <Form.Control name="birthday" type="text" placeholder='birthday' defaultValue={user.birthday} onFocus={(e) => (e.target.type = "date")} onBlur={(e) => (e.target.type = "text")} />
                </Form.Group>
                
                
                <Button variant="primary" type="submit" className='w-50 btn btn-lg btn-success' style={{marginLeft: "50%"}} disabled={buttonState}>
                    Submit
                </Button>
            </div>
        </Form>
